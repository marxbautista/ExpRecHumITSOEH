...
namespace PresentacionRH
{
    public partial class frmPersonal : Form
    {
        ...
        private void inicializaCajas()
        {
            ...
            txtRutaImagen.Text = AppDomain.CurrentDomain.BaseDirectory + "Imagenes\\NoDisponible.png".ToString();
            pictureBox1.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + "Imagenes\\NoDisponible.png");
        ...
        private Boolean validaPass(){
            ...
            {
                MessageBox.Show("Coloque una contrasena de acceso para Continuar", "Mensaje de Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                esCorrecto = true;
            }
            else if (String.IsNullOrEmpty(txtac2.Text))
            {
                MessageBox.Show("Repita la contrasena para Continuar", "Mensaje de Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                esCorrecto = true;
            }
            else if (txtac1.Text != txtac2.Text)
            {
                MessageBox.Show(this, "Las contrasenas no son iguales. Verificalo!", "Mensaje de Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                esCorrecto = true;
            }
            return esCorrecto;
        }
        ...
        private Boolean Guardar()
        {
            ...
            try
            {
                ...
                if (!validarCajas())
                {
                    ...
                    _personal.CveAcceso = txtac1.Text;
                    ...
                    _cPersonal.registrar(_personal);

                    MessageBox.Show("Personal registrado/actualizado con éxito");
        ...
        private void TraerPorId(int id)
        {
            try
            {
                ...
                if (_personal != null)
                {
                    ...
                    txtac1.Enabled = false;
                    txtac2.Enabled = false;
